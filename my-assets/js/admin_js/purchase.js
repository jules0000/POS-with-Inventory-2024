  ...
  if (count == limits) {
    ...
    newdiv.innerHTML = `
            <td class="span3 supplier">
                <input type="text" name="product_name[]" required class="form-control product_name productSelection" onkeypress="product_pur_or_list(${count});" placeholder="Product Name" id="product_name_${count}" tabindex="${tab1}">
                <input type="hidden" class="autocomplete_hidden_value product_id_${count}" name="product_id[]" id="product_id_${count}">
            ...
            <td class="text-right">
                <input type="text" name="product_quantity[]" tabindex="${tab2}" required id="cartoon_${count}" class="form-control text-right store_cal_${count}" onkeyup="calculate_store(${count});" onchange="calculate_store(${count});" placeholder="0.00" value="" min="0">
            </td>
            <td class="test">
                <input type="text" name="product_rate[]" onkeyup="calculate_store(${count});" onchange="calculate_store(${count});" id="product_rate_${count}" class="form-control product_rate_${count} text-right" placeholder="0.00" value="" min="0" tabindex="${tab3}">
            </td>
            <td class="text-right">
            ...
            <td>
                ...
                <button style="text-align: right;" class="btn btn-danger red" type="button" onclick="deleteRow(this)" tabindex="8">
    ...
    buttons: [
      {
        ...
        title: "PurchaseList",
        exportOptions: {
          columns: [0, 1, 2, 3, 4, 5], // Your column values those you want
        },
      ...
      },
      {
        ...
        title: "PurchaseList",
        exportOptions: {
          columns: [0, 1, 2, 3, 4, 5], // Your column values those you want print
        },
        className: "btn-sm prints",
      },
      {
