...
<head>
    ...
    <title>Wheeltech POS Inventory System Installation</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                    <header class="header">
                        <h1 class="header-title">Wheeltech POS Inventory System Installation</h1>
                    </header>
                    <div class="page-content">
                        <div class="outer-container">
                            <div id="wizard" class="aiia-wizard">
                                <?php 
                            if (isset($_GET['step1']) || (!isset($_GET['step1']) && !isset($_GET['step2']) && !isset($_GET['step3']) && !isset($_GET['complete']))) {
                                    $activeClass = 'active';
                                } 
                            ?>
                                <div class="aiia-wizard-step <?php echo (isset($_GET['step1'])?'active':'') ?>">
                                    <h1>Configurations</h1>
                                    <div class="step-content step-two">
                                        <div class="app_content">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <h3 class="title text-center"><strong>Directory permissions &
                                    ...
                                    <div class="row action_btns">
                                        <button
                                            class='btn btn-success pull-left aiia-wizard-button-previous prev_action'>Previous</button>
                                    ...
                                    <form action="index.php?step3=true" method="post">
                                        ...
                                        <div class="step-content step-three">
                                            ...
                                            <input type="hidden" name="_token"
                                                value="<?php echo  (!empty($token)?$token:null) ?>" />
                                            ...
                                            <div class="form-group">
                                                <label for="hostname">Host Name <span
                                                        ...
                                                        title="Please keep localhost by default, but if need you can add your own domain name or ip address"></span></label>
                                                <input type="text" name="hostname" class="form-control" id="hostname"
                                                    placeholder="Host Name" value="localhost">
                                            </div>
                                ...
                                <div class="aiia-wizard-step <?php echo (isset($_GET['step3'])?'active':'') ?>">
                                    <h1>Credential</h1>
                                    <p class="text-center">Please add your own initial Email and Password. Please change
                                        that after login</p>
                                    <?php
                                    if (!empty($message)) {
                                        echo "<div class=\"alert alert-danger\"><ul>$message</ul></div>";
                                    ...
                                    <form action="index.php?step4=true" method="post" class="form-horizontal">
                                        ...
                                        <div class="row action_btns">
                                            ...
                                            <button
                                                class='btn btn-success pull-left aiia-wizard-button-previous prev_action logininfo hide'>Previous</button>
                                            <button type="submit"
                                                class='btn btn-success pull-right logininfo hide'>Next</button>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <div class="step-content step-five">
                                        ...
                                        ?>
                                            ...
                                            <div class="text-center hide" id="btn-complete">
                                                <a href="index.php?complete=true&launchapp=true"
                                                    class="btn btn-block cbtn">Finish Installation Process</a>
                                            </div>
    ...
    <footer class="footer text-center">
        <div class="container fText">
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                <div class="row">
                    <div class="col-sm-6 text-left">Developed by <a target="_blank"
                            href="https://www.facebook.com/profile.php?id=100065316557016">WHEELTECH Motorcycle Parts
                            and Accessories</a></div>
                    <div class="col-sm-6  text-right"><a target="_blank"
                            href="https://www.facebook.com/profile.php?id=100065316557016"><span
                                class="glyphicon glyphicon-user"></span> Installation Support</a></div>
                </div>
            </div>
        </div>
    </footer>
