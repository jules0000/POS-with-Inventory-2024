                    ...
                    <div class="d-flex align-items-center mb-5">
                        <div class="input-group mr-3">
                            <input type="text" class="form-control customerSelection" id="customer_name"
                                value="<?php echo $customer_name;?>" tabindex="3" onkeyup="customer_autocomplete()"
                                name="customer_name">
                    ...
                    <div class="footer">
                        ...
                        <div class="form-group row guifooterpanel">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 col-lg-5 col-xl-4"><input type="text" id="total_discount_ammount"
                        ...
                        <div class="form-group row guifooterpanel">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 col-lg-5 col-xl-4"><input type="text" id="grandTotal"
                                        class="form-control gui-foot text-right" name="grand_total_price" value="0.00"
                                        readonly="readonly" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-4 text-xl-right">
                                    <div class="action-btns d-flex justify-content-end">
                                        <input type="button" id="full_paid_tab" class="btn btn-warning btn-lg mr-2"
                                            value="Full Paid" tabindex="14" onClick="full_paid()" />
