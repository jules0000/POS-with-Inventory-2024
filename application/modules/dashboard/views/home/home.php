...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        <div class="small-box bg-green whitecolor">
            ...
            <a href="<?php echo base_url('customer_list') ?>" class="small-box-footer"></a>
            <?php }else{?>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        <div class="small-box bg-pase whitecolor">
            ...
            <a href="<?php echo base_url('product_list') ?>" class="small-box-footer"></a>
            <?php }else{?>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        <div class="small-box bg-bringal whitecolor">
            ...
            <a href="<?php echo base_url('supplier_list') ?>" class="small-box-footer"> </a>
            <?php }else{?>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        <div class="small-box bg-darkgreen whitecolor">
            ...
            <a href="<?php echo base_url('invoice_list') ?>" class="small-box-footer"> </a>
            <?php }else{?>
