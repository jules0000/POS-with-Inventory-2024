                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'edit_service_invoice/'.$services['voucher_no']; ?>"
                                        ...
                                        <a href="<?php echo base_url() . 'service/service/service_invoic_delete/'.$services['voucher_no']; ?>"
                                            class="btn btn-danger btn-sm" name="<?php echo $services['voucher_no'];?>"
                                            onclick="return confirm('<?php echo display('are_you_sure') ?>')"
                                            data-original-title="<?php echo display('delete') ?> "><i
                                                class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        <?php }?>
                                        <a href="<?php echo base_url() . 'service/service/servicedetails_download/'.$services['voucher_no']; ?>"
                                            class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left"
                                            title="<?php echo display('download') ?>"><i class="fa fa-download"
                                                aria-hidden="true"></i></a>
                                        <a href="<?php echo base_url() . 'service_details/'.$services['voucher_no']; ?>"
                                            class="btn btn-success btn-sm" name="<?php echo $services['voucher_no'];?>"
                                            data-original-title="<?php echo display('details') ?> "><i class="fa fa-eye"
                                                aria-hidden="true"></i></a>
                                        <?php echo form_close() ?>
                                    </center>
                                </td>
