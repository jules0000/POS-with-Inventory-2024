                            ...
                            <tr>
                                <div class="col-sm-8 company-content">
                                    ...
                                    <address class="margin-top10">
                                        <strong
                                            class="company_name_p"><?php echo $company_info[0]['company_name']?></strong><br>
                                ...
                                <div class="col-sm-4 text-left invoice-address">
                                    ...
                                    <div class="m-b-15"><?php echo display('hanging_over') ?>:<?php echo $final_date?>
                                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div><strong><?php echo $details['service_name']?></strong></div>
                                    </td>
