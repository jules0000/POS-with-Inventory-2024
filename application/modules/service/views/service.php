<div class="row">
    <div class="col-sm-12">
        ...
        <a href="<?php echo base_url('add_service') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i>
            <?php echo display('add_service') ?> </a>
        <?php }?>
                              ...
                              $tax = 'tax'.$i;
                                ...
                                <td>
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'edit_service/'.$services['service_id']; ?>"
                                        ...
                                        <a href="<?php echo base_url('service/service/service_delete/'.$services['service_id']) ?>"
                                            class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right"
                                            title="delete" onclick="return confirm('Are Your Sure ?')"
