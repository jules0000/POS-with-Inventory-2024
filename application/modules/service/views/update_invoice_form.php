                        ...
                        <tbody id="addinvoiceItem">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" id="all_discount_<?php echo $sl;?>" class="total_discount"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" onkeyup="quantity_calculate(1);"
                                        ...
                                        class="form-control text-right" name="invoice_discount" placeholder="0.00"
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <input type="submit" id="add_invoice" class="btn btn-success" name="add-invoice"
                                        value="<?php echo display('save_changes') ?>" tabindex="15" />
                                </td>
