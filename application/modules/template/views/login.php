...
<head>
    ...
    body {
        ...
        color: #333;
        background-image: url("my-assets/image/bg/bg.jpg");
        ...
        <div class="panel panel-bd">
            <div class="panel-heading">
                <div class="view-header" style="display: flex; align-items: center;">
                    <div class="header-icon" style="margin-right: 15px;">
                        <img src="assets/img/icons/logo.png" alt="Image Description" style="width:80px;height:80px;" />
                    </div>
                    <div class="header-title">
                        <h3><?php echo (!empty($setting->title) ? $setting->title : null) ?></h3>
                        <br>
                        <small>
                            <h4>WHEELTECH Motorcycle Parts and Accessories POS and Inventory System</h4>
                        </small>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <span>
                        <a href="#" data-toggle="modal" data-target="#passwordrecoverymodal">
                            <b class="text-right"><?php echo display('forgot_password') ?></b>
                        </a>
                    </span>
                </div>
