        ...
        <div class="content-wrapper">
            <div class="container">
                            ...
                            <div class="outer-container">
                                ...
                                <div class="box-inner">
                                    ...
                                    <div class="text-right">
                                        <a href="<?php echo base_url()?>installer/remove_installer"
                                            class="btn btn-danger btn-block">Delete Now</a>
                                    </div>
                                ...
                                <div class="instruction">
                                    ...
                                    <ul class="step-list">
                                        <li><span>1.</span> Go to the root folder of your server where placed all the
                                            files. ex: public_html/</li>
                ...
                <footer class="footer text-center">
                    <div class="container">
                        <div class="fText">Developed by <a target="_blank"
                                href="https://www.facebook.com/profile.php?id=100065316557016">WHEELTECH Motorcycle
                                Parts
